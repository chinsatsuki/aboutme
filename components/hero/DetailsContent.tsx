...
export const DetailsContent = () => {
  ...
  const linkStyle = "text-[var(--muted-foreground)] hover:text-[var(--brand-orange)] transition-colors duration-300 cursor-pointer text-[13px] font-medium leading-tight block";
  return (
